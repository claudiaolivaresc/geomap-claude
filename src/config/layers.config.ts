            ...
            layers: [
              {
                ...
                title: 'Vs 110km (Test)',
                schema: 'subsurface',
                table: 'gl_vs_110_tests',
                source: {
                  type: 'raster',
                  tiles: [`${TILESERVER_URLS.raster}/tiles/subsurface.gl_vs_110_tests/{z}/{x}/{y}.png`],
                  tileSize: 256,
                  minzoom: 0,
                  maxzoom: 8,
                },
                ...
                metadata: {
                  description: 'Shear wave velocity at 110km depth — test version for comparison.',
                },
                permissions: { visibility: 'public', allowedCompanies: [] },
                defaultVisible: false,
                defaultOpacity: 0.8,
              },
              {
                ...
                title: 'Vs 150km (Test)',
                schema: 'subsurface',
                table: 'gl_vs_150_tests',
                source: {
                  type: 'raster',
                  tiles: [`${TILESERVER_URLS.raster}/tiles/subsurface.gl_vs_150_tests/{z}/{x}/{y}.png`],
                  tileSize: 256,
                  minzoom: 0,
                  maxzoom: 8,
                },
                ...
                metadata: {
                  description: 'Shear wave velocity at 150km depth — test version for comparison.',
                },
                permissions: { visibility: 'public', allowedCompanies: [] },
                defaultVisible: false,
                defaultOpacity: 0.8,
              ...
              {
                id: 'gl_vs_avg_110_150_tests',
                type: 'raster',
                title: 'Vs Avg 110-150km (Test)',
                schema: 'subsurface',
                table: 'gl_vs_avg_110_150_tests',
                source: {
                  type: 'raster',
                  tiles: [`${TILESERVER_URLS.raster}/tiles/subsurface.gl_vs_avg_110_150_tests/{z}/{x}/{y}.png`],
                  tileSize: 256,
                  minzoom: 0,
                  maxzoom: 8,
                },
                ...
                metadata: {
                  description: 'Average shear wave velocity between 110-150km depth — test version.',
                },
                permissions: { visibility: 'public', allowedCompanies: [] },
                defaultVisible: false,
                defaultOpacity: 0.8,
